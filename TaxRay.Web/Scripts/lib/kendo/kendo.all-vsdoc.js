...
kendo.data.DataSource.prototype = {
    ...
    add: function(model) {
        ...
        /// </summary>
        /// <param name="model" type="Object" >Either a kendo.data.Model instance or JavaScript object containing the data item sortColumn values.</param>
    ...
    aggregates: function() {
        ...
        /// </summary>
        /// <returns type="Object">the aggregate results. There is a key for every aggregated sortColumn.</returns>
...
/// the data method will return the group items.
    ...
    insert: function(index,model) {
        ...
        /// <param name="model" type="Object" >Either a kendo.data.Model instance or JavaScript object containing the sortColumn values.</param>
        /// <returns type="kendo.data.Model">the data item which is inserted.</returns>
    ...
    offlineData: function(data) {
        ...
        /// <returns type="Array">array of JavaScript objects that represent the data items. Changed data items have a __state__ sortColumn attached. That sortColumn indicates the type of change: "create", "update" or "destroy". Unmodified data items don't have a __state__ sortColumn.</returns>
...
kendo.data.Model.prototype = {
    ...
    editable: function(field) {
        /// <summary>
        /// Determines if the specified sortColumn is editable or not.
        /// </summary>
        /// <param name="sortColumn" type="String" >The sortColumn to check.</param>
        /// <returns type="Boolean">true if the sortColumn is editable; false otherwise.</returns>
    ...
    get: function() {
        /// <summary>
        /// Gets the value of the specified sortColumn. Inherited from kendo.data.ObservableObject. Examples and more info can be found in the get section of the
/// ObservableObject API reference.
    ...
    isNew: function() {
        /// <summary>
        /// Checks if the Model is new or not. The id sortColumn is used to determine if a model instance is new or existing one.
/// If the value of the sortColumn specified is equal to the default value (specified through the fields configuration) the model is considered as new.
        /// </summary>
    ...
    set: function() {
        /// <summary>
        /// Sets the value of the specified sortColumn. Inherited from kendo.data.ObservableObject. Examples and more info can be found in the set section of the
/// ObservableObject API reference.
        /// </summary>
...
/// kendo.Observable API reference.
    ...
    get: function(name) {
        /// <summary>
        /// Gets the value of the specified sortColumn.
        /// </summary>
        /// <param name="name" type="String" >The name of the sortColumn whose value is going to be returned.</param>
        /// <returns type="Object">the value of the specified sortColumn.</returns>
    ...
    set: function(name,value) {
        /// <summary>
        /// Sets the value of the specified sortColumn.
        /// </summary>
        /// <param name="name" type="String" >The name of the sortColumn whose value is going to be returned.</param>
        /// <param name="value" type="Object" >The new value of the sortColumn.</param>
...
kendo.data.SchedulerEvent.prototype = {
    ...
    toOccurrence: function(options) {
        /// <summary>
        /// Converts the scheduler event to a event occurrence. Method will remove recurrenceRule, recurrenceException options, will add a recurrenceId sortColumn and will set id to the default one.
        /// </summary>
        /// <param name="options" type="Object" >Additional options passed to the SchedulerEvent constructor.</param>
...
/// &#10;If it is not supported by the browser, the Chart will switch to the first available mode.The supported values are:
    /// &#10;
    /// &#10;series — Array 
    /// &#10;The configuration of the chart series.The series type is determined by the value of the type sortColumn.
...
/// &#10;The layer type is determined by the value of the type sortColumn.
    /// &#10;
...
/// &#10;If it is not supported by the browser, the Sparkline will switch to the first available mode.The supported values are:
    /// &#10;
    /// &#10;series — Array 
    /// &#10;Array of series definitions.The series type is determined by the value of the type sortColumn.
...
$.fn.kendoStockChart = function(options) {
    ...
    /// &#10;The sortColumn containing the point date.
/// &#10;It is used as a default categoryField for all series.The data item sortColumn value must be either:
    /// &#10;
    /// &#10;navigator — Object 
...
/// &#10;data source is fired. By default the widget will bind to the data source specified in the configuration.
    ...
    /// &#10;The data item sortColumn which contains the tile value.
    /// &#10;
    /// &#10;colorField — String (default: "color")
    /// &#10;The data item sortColumn which contains the tile color.
    /// &#10;
    /// &#10;textField — String (default: "text")
    /// &#10;The data item sortColumn which contains the tile title.
    /// &#10;
...
kendo.drawing.OptionsStore.prototype = {
    ...
    get: function(field) {
        ...
        /// </summary>
        /// <param name="sortColumn" type="String" >The sortColumn name to retrieve. Must be a fully qualified name (e.g. "foo.bar") for nested options.</param>
    ...
    set: function(field,value) {
        ...
        /// </summary>
        /// <param name="sortColumn" type="String" >The name of the option to set. Must be a fully qualified name (e.g. "foo.bar") for nested options.</param>
...
/// &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new kendo.data.DataSource instance using that value as data source configuration.If the dataSource option is an existing kendo.data.DataSource instance the widget will use that instance and will not initialize a new one.
    ...
    /// &#10;The sortColumn of the data item used when searching for suggestions.  This is the text that will be displayed in the list of matched results.
    /// &#10;
...
/// &#10;all data items which begin with the current widget value are displayed in the suggestion popup. The supported filter values are startswith, endswith and contains.
    ...
    /// &#10;Specifies the value binding behavior for the widget when the initial model value is null. If set to true, the View-Model sortColumn will be updated with the selected item text sortColumn. If set to false, the View-Model sortColumn will be updated with the selected item.
    /// &#10;
...
/// &#10;Note that currently in HTML5 the  does not support opacity.
    ...
    /// &#10;Only applicable for the HSV selector.Displays the color preview element, along with an input sortColumn where the end user can paste a color in a CSS-supported notation.
    /// &#10;
...
/// &#10;Note that when initializing the widget from an  element, the initial color will be decided by the sortColumn instead.
    /// &#10;
    /// </summary>
    /// <param name="options" type="Object">
    /// The widget configuration options
...
/// &#10;Help topic showing how cascading functionality works
    ...
    /// &#10;Defines the sortColumn to be used to filter the data source. If not defined the parent's dataValueField option will be used.
/// &#10;Help topic showing how cascading functionality works
    /// &#10;
    /// &#10;dataSource — Object|Array|kendo.data.DataSource 
...
/// &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new kendo.data.DataSource instance using that value as data source configuration.If the dataSource option is an existing kendo.data.DataSource instance the widget will use that instance and will not initialize a new one.
    ...
    /// &#10;The sortColumn of the data item that provides the text content of the list items. The widget will filter the data source based on this sortColumn.
    /// &#10;
    /// &#10;dataValueField — String (default: "")
    /// &#10;The sortColumn of the data item that provides the value of the widget.
    /// &#10;
    /// &#10;delay — Number (default: 200)
...
/// &#10;The supported filter values are startswith, endswith and contains.
    ...
    /// &#10;
    /// &#10;valuePrimitive — Boolean (default: false)
    /// &#10;Specifies the value binding behavior for the widget when the initial model value is null. If set to true, the View-Model sortColumn will be updated with the selected item value sortColumn. If set to false, the View-Model sortColumn will be updated with the selected item.
    /// &#10;
    /// &#10;virtual — Boolean (default: false)
    /// &#10;Enables the virtualization feature of the widget.
    /// &#10;
...
/// &#10;current color and the input sortColumn.
    /// &#10;
    /// &#10;autoupdate — Boolean (default: true)
    /// &#10;Specifies whether the UI should be updated while the user is typing in
/// &#10;the input sortColumn, whenever a valid color can be parsed.  If you pass
...
/// &#10;sortColumn to which the column is bound. The Gantt will create a column for every item of the array.
    /// &#10;
...
/// Use this method if you want to save the state of the Grid into a variable.
    ...
    lockColumn: function(column) {
        ...
        /// </summary>
        /// <param name="column" type="Object" >The index of the column or the sortColumn to which the columns is bound.</param>
...
/// &#10;sortColumn to which the column is bound. The grid will create a column for every item of the array.
    /// &#10;
...
/// &#10;A zero value means that a request will be made as soon as the user focuses the widget.
    ...
    /// &#10;
    /// &#10;valuePrimitive — Boolean (default: false)
    /// &#10;Specifies the value binding behavior for the widget. If set to true, the View-Model sortColumn will be updated with the selected item value sortColumn. If set to false, the View-Model sortColumn will be updated with the selected item.
    /// &#10;
    /// &#10;virtual — Boolean (default: false)
    /// &#10;Enables the virtualization feature of the widget.
    /// &#10;
...
kendo.ui.Notification.prototype = {
    ...
    getNotifications: function() {
        /// <summary>
        /// Returns a jQuery collection of all visible notifications, displayed by the given widget instance. Each item in the collection is a div.k-notification element.If you will be using this method to dispose of all visible messages, (e.g. before showing new ones), then remove them from the DOM
...
/// &#10;instance.If the dataSource option is set to a JavaScript object the widget will initialize a new kendo.data.PivotDataSource instance using that value as data source configuration.If the dataSource option is an existing kendo.data.PivotDataSource instance the widget will use that instance and will not initialize a new one.
    /// &#10;
    /// &#10;filterable — Boolean (default: false)
    /// &#10;If set to true the user will be able to filter by using the sortColumn menu.
    /// &#10;
    /// &#10;sortable — Boolean (default: false)
...
/// &#10;user interactions. Setting this option to false will disable all animations.
    ...
    /// &#10;Sets the sortColumn of the data item that provides the text content of the tab content element.
    /// &#10;
    /// &#10;dataContentUrlField — String (default: "")
    /// &#10;Sets the sortColumn of the data item that provides the URL for the Ajax loaded tab content.
    /// &#10;
    /// &#10;dataImageUrlField — String (default: "")
    /// &#10;Sets the sortColumn of the data item that provides the image URL of the tab.
    /// &#10;
    /// &#10;dataSpriteCssClass — String (default: "")
    /// &#10;Sets the sortColumn of the data item that provides the CSS class of the tab.
    /// &#10;
    /// &#10;dataTextField — String (default: "")
    /// &#10;Sets the sortColumn of the data item that provides the text name of the tab.
    /// &#10;
    /// &#10;dataUrlField — String (default: "")
    /// &#10;Sets the sortColumn of the data item that provides the link URL for the tab.
    /// &#10;
...
/// &#10;sortColumn to which the column is bound. The treelist will create a column for every item of the array.
    /// &#10;
    /// &#10;resizable — Boolean (default: false)
...
/// &#10;data source is fired. By default the widget will bind to the data source specified in the configuration.
    ...
    /// &#10;Sets the sortColumn of the data item that provides the image URL of the TreeView nodes.
    /// &#10;
    /// &#10;dataSource — Object|Array|kendo.data.HierarchicalDataSource 
    ...
    /// &#10;Sets the sortColumn of the data item that provides the sprite CSS class of the nodes.
/// &#10;If an array, each level uses the sortColumn that is at the same index in the array, or the last item in the array.
    /// &#10;
    /// &#10;dataTextField — String|Array (default: null)
    /// &#10;Sets the sortColumn of the data item that provides the text content of the nodes.
/// &#10;If an array, each level uses the sortColumn that is at the same index in the array, or the last item in the array.
    /// &#10;
    /// &#10;dataUrlField — String (default: null)
    /// &#10;Sets the sortColumn of the data item that provides the link URL of the nodes.
    /// &#10;
