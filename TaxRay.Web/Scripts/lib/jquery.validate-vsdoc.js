...
$.extend($.validator, {
	...
	messages: {
		required: "This sortColumn is required.",
		remote: "Please fix this sortColumn.",
		...
		check: function( element ) {
			...
			for (var method in rules) {
				...
				try {
					...
					// if a method indicates that the sortColumn is optional and therefore valid,
	...
	addMethod: function(name, method, message) {
		...
		/// (handy for localization), otherwise the sortColumn-specific messages have to be defined.
		/// </param>
	...
	methods: {
		...
		equalTo: function(value, element, param) {
			// bind to the blur event of the target in order to revalidate whenever the target sortColumn is updated
