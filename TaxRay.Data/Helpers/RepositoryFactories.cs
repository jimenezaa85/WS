...
namespace TaxRay.Data.Helpers
{
    ...
    public class RepositoryFactories
    {
        ...
        /// <remarks>
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetTaxRayFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(ITaxReturnRepository), dbContext => new TaxReturnRepository(dbContext)}
                };
        }
        ...
        {
            _repositoryFactories = GetTaxRayFactories();
        }
        ...
        /// </remarks>
        public virtual Func<DbContext, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        {
            return dbContext => new EntityFrameworkRepository<T>(dbContext);
        }
